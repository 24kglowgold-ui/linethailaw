...
const cron = require('node-cron'); // Required for daily reset
...
// --- DAILY RESET LOGIC ---
// This triggers at 00:00 (Midnight) every day in Bangkok time
cron.schedule('0 0 * * *', () => {
...
const LANGUAGES = {
    ...
    'english': {
        ...
        // Modified per your request
        payButton: "Subscribe 20 THB for daily unlimited access",
