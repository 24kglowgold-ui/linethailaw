...
// Tracker is kept for logging purposes but the limit check is removed
...
async function handleEvent(event) {
    ...
    // Track usage for monitoring, but the blocking 'if' block has been removed
    ...
    try {
        ...
        // Robust reply logic with Push Message fallback remains active
