...
async function handleEvent(event) {
    ...
    try {
        ...
        // Solve "Invalid reply token" by using Push Message as a fallback if reply fails
        ...
        await client.pushMessage({ to: userId, messages: [{ type: 'text', text: "Busy... Try again in a moment." }] }).catch(e => {});
    }
}
