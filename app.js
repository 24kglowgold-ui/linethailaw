...
const LANGUAGES = {
    ...
    'english': {
        ...
        limitText: "Free limit reached. Subscribe for unlimited access.",
...
app.post('/webhook', line.middleware(config), (req, res) => {
    res.status(200).send('OK'); // Tell LINE we got it immediately
    
    const events = req.body.events;
    for (const event of events) {
        handleEvent(event); // Run this in the background
    }
});
...
async function handleEvent(event) {
    ...
    // If you want to keep the 5-limit logic, keep this. If you want to remove it, delete these 10 lines.
        ...
        return await client.replyMessage({
            ...
            messages: [{
                ...
                template: {
                    ...
                    text: lang.limitText,
                    actions: [{ type: 'uri', label: lang.payButton, uri: 'https://docs.google.com/forms/d/...' + userId }]
                }
            }]
        }).catch(err => console.error("Limit Reply Error:", err.message));
    }
    ...
    try {
        ...
        // Because we replied "OK" early, the replyToken might be expired. 
        // This logic will automatically use Push Message to deliver the answer.
