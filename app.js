...
const LANGUAGES = {
    'thai': {
        ...
        limitText: "คุณใช้สิทธิ์ครบ 10 ข้อแล้ว สมัครสมาชิกเพื่อใช้งานต่อ", // Updated to 10
    ...
    'english': {
        ...
        limitText: "Free limit reached (10 questions). Subscribe for unlimited daily access.", // Updated to 10
    ...
    'chinese': {
        ...
        limitTitle: "已达到每日上限",
        limitText: "您已达到10个问题的免费额度。支付 20 泰铢订阅。 ", // Updated to 10
        payButton: "支付 20 泰铢",
        disclaimer: "\n\n**免责声明：** 本信息不构成正式法律建议。",
        ctaLabel: "咨询律师"
    },
    'traditional_chinese': {
        ...
        limitTitle: "已達到每日上限",
        limitText: "您已達到10個問題的免費額度。支付 20 泰銖訂閱。 ", // Updated to 10
        payButton: "支付 20 泰銖",
        disclaimer: "\n\n**免責聲明：** 本信息不構成正式法律建議。",
        ctaLabel: "諮詢律師"
    }
...
async function handleEvent(event) {
    ...
    // 2. Check Daily Limit (Updated to 10)
    if (!userMessageCounts[userId]) userMessageCounts[userId] = 0;
    if (userMessageCounts[userId] >= 10) { // Changed from 5 to 10
